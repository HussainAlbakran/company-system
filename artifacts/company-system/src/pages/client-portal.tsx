        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-6">
              ...
              <button onClick={handleLogout} className="text-slate-300 hover:text-white transition-colors flex items-center gap-2 text-sm font-medium" data-testid="button-logout-client">
        ...
        <div className="bg-white rounded-2xl p-6 md:p-8 shadow-sm border border-slate-200 mb-8 relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
            ...
            <div className="flex gap-3">
              <button className="bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 px-4 py-2.5 rounded-lg font-medium transition-all flex items-center gap-2 text-sm shadow-sm" data-testid="button-contact-eng">
                <MessageSquare className="w-4 h-4" />
                تواصل مع المهندس
              </button>
              <button className="bg-slate-900 hover:bg-slate-800 text-white px-4 py-2.5 rounded-lg font-medium transition-all shadow-md flex items-center gap-2 text-sm" data-testid="button-request-mod">
                طلب تعديل/إضافة
              </button>
            </div>
          </div>
                  ...
                  <div className="relative pl-0 pr-12 mb-8">
                    ...
                    <div className="bg-white border border-slate-100 rounded-xl p-5 shadow-sm hover:shadow-md transition-shadow">
                      ...
                      <div className="flex gap-3 overflow-x-auto pb-2">
                        <div className="w-32 h-24 bg-slate-200 rounded-lg flex items-center justify-center text-slate-400 border border-slate-300 flex-shrink-0">صورة 1</div>
                        <div className="w-32 h-24 bg-slate-200 rounded-lg flex items-center justify-center text-slate-400 border border-slate-300 flex-shrink-0">صورة 2</div>
                      </div>
                    </div>
                  </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
              ...
              <div className="p-2">
                {[
                  ...
                  <button key={i} className="w-full flex items-center justify-between p-4 rounded-xl hover:bg-slate-50 group transition-colors text-right" data-testid={`doc-${i}`}>
                    <div className="flex items-center gap-3">
