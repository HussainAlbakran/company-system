...
return [
    ...
    'hr_module_only' => 'هذه الصفحة متاحة لمدير النظام والإدارة العليا وموارد البشرية فقط.',
    'basic_user_denied' => 'لا يمكن الوصول إلى هذا القسم.',
    'super_admin_route_denied' => 'هذا القسم غير متاح لصلاحية الإدارة العليا.',
];
