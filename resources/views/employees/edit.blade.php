        ...
        <form action="{{ route('employees.update', $employee) }}" method="POST">
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="number" step="0.01" min="0" max="100" name="insurance_deduction_percent" value="{{ old('insurance_deduction_percent', $employee->insurance_deduction_percent ?? 0) }}">
