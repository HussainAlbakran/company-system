...
@section('page_title', __('factory.factory_create_page_title'))
@section('page_subtitle', __('factory.factory_create_sub', ['name' => $project->name]))

@section('content')
<x-ui.card :title="__('factory.factory_create_page_title')" :subtitle="__('factory.factory_create_sub', ['name' => $project->name])">
